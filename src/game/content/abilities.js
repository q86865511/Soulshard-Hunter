...
// ---- tier 2 (rare) ---------------------------------------------------------
A({ id: 'multishot', name: '分裂魂彈', tier: 2, weight: 4, maxStacks: 3, desc: '投射物數量 +1', apply: (p) => p.stats.projCountAdd += 1 });
A({ id: 'pierce', name: '貫穿之矢', tier: 2, weight: 5, maxStacks: 4, desc: '穿透 +1', apply: (p) => p.stats.pierceAdd += 1 });
A({ id: 'lifesteal', name: '吸血鬼牙', tier: 2, weight: 3, maxStacks: 3, desc: '吸血 +2%', apply: (p) => p.stats.lifesteal += 0.02 });
