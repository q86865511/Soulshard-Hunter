...
export const EVENTS = [
  ...
  { id: 'ev_wall', host: '守衛', name: '鐵壁', desc: '減傷 +2、生命上限 +24', apply: (s) => { s.player.stats.defense += 2; s.player.stats.maxHp += 24; s.player.heal(24); } },
  ...
  { id: 'ev_vamp', host: '血祭司', name: '嗜血', desc: '吸血 +4%', apply: (s) => { s.player.stats.lifesteal = (s.player.stats.lifesteal || 0) + 0.04; } },
  { id: 'ev_spread', host: '砲手', name: '擴散彈', desc: '投射物 +1', apply: (s) => { s.player.stats.projCountAdd = (s.player.stats.projCountAdd || 0) + 1; } },
