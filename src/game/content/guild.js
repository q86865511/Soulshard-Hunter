...
export const GUILD_RANKS = [
  ...
  { xp: 150,   name: '鐵章 · 正式會員', reward: { gold: 150, label: '＋150 金幣' } },
  { xp: 400,   name: '銅星 · 賞金獵人', reward: { grant: U('weapons', 'w_soulstorm'), label: '武器「魂晶風暴」' } },
  { xp: 800,   name: '青銅 · 老練會員', reward: { gold: 180, grant: U('abilities', 'overload'), label: '被動「過載」＋180 金幣' } },
  { xp: 1400,  name: '白銀 · 銀章獵人', reward: { grant: U('equipment', 'g_dragon_scale'), label: '裝備「龍鱗甲」' } },
  { xp: 2200,  name: '銀星 · 精英獵人', reward: { gold: 260, grant: U('items', 'it_timeslow_burst'), label: '道具「時滯爆發」＋260 金幣' } },
  { xp: 3200,  name: '黃金 · 金章好手', reward: { grant: U('weapons', 'g_laserbeam'), label: '武器「聚能雷射」' } },
  { xp: 4600,  name: '金星 · 名譽會員', reward: { gold: 360, grant: U('abilities', 'g_executioner'), label: '被動「處決」＋360 金幣' } },
  { xp: 6400,  name: '白金 · 白金獵人', reward: { grant: U('equipment', 'ep_chromatic_core'), label: '史詩裝備「彩晶核心」' } },
  { xp: 8800,  name: '鑽石 · 鑽石獵人', reward: { gold: 500, grant: U('weapons', 'g_blackhole'), label: '武器「黑洞」＋500 金幣' } },
  { xp: 12000, name: '星辰 · 公會之星', reward: { grant: (m) => { U('abilities', 'ac_warbanner')(m); U('equipment', 'ep_void_mantle')(m); }, label: '被動「戰旗」+ 史詩「虛空斗篷」' } },
  { xp: 16000, name: '傳奇 · 公會之柱', reward: { gold: 1200, grant: U('items', 'g_purge_wave'), label: '道具「淨化波」＋1200 金幣' } },
];
