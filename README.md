...
- 城鎮永久成長（天賦樹 + 設施，**消費隨購買次數動態漲價**）、可互動的**任務公會（接取一般/隱藏任務、前置任務鏈、可同時追蹤多個）/ 成就殿堂（全部・已達成・未達成 篩選）/ 衣帽店（**兩層式：選角色→該角色全造型，分層定價 + 每週特賣**）/ 魂晶銀行（**自訂金額借款，下一局結算自動連本帶利還款**）建築**、**追蹤任務常駐螢幕左側（多列堆疊）**、**成就解鎖內容**、**開場故事過場 + 新手教學**（城鎮嚮導 + 首局戰鬥提示 + HUD 導覽）、選角頁顯示英雄能力差異、金幣經濟
